...
import styles from "@/styles/presets/TriggerdevFrame.module.css";
import sharedStyles from "@/styles/presets/DefaultFrame.module.css";

const TRIGGER_PATTERN_URL = "/editor/assets/triggerdev/pattern.svg";
...
const TriggerdevFrame = ({
  ...
  return (
    ...
    >
      ...
      {showBackground && (
        <>
          <div className={styles.patternTop} style={{ backgroundImage: `url(${TRIGGER_PATTERN_URL})` }} />
          <div className={styles.patternBottom} style={{ backgroundImage: `url(${TRIGGER_PATTERN_URL})` }} />
        </>
      )}
