...
import ProfileDropdown from "@/app/(navigation)/preview/components/profile-dropdown";
...
export default function PreviewLayout({ options }: PreviewLayoutProps) {
  return (
    <React.Fragment>
      {" "}
        ...
        <div className="flex h-16 items-center justify-between gap-4 max-w-4xl mx-auto w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="ml-2 flex items-center gap-2">
              ...
              <div className="relative">
                <Avatar>
                  <AvatarImage alt="Martha Johnson" />
